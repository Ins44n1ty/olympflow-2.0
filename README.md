...
Clustering-скрипты группируют задачи по похожести, сравнивают разные варианты кластеризации, экспортируют лучшие кластеры, проверяют их устойчивость и строят автоматическую интерпретацию через ключевые термины и representative tasks. Дополнительно строятся 2D-визуализации кластеров через PCA и t-SNE, чтобы можно было увидеть, образуют ли задачи визуальные “облачка” в пространстве признаков.
